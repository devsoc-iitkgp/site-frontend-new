    ...
    <div className="features-section">
      <div className="features-container">
        <div className="features-header">
          <h3 className="features-title">Where developers connect, create, and grow.</h3>
          <p className="features-subtitle">
            The DevSoc community — your home for collaboration, learning, and building impactful projects.
          </p>
        </div>
